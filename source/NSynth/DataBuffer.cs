...
namespace NSynth
{
    ...
    public sealed class DataBuffer
    {
        ...
        {
            Contract.Requires(this.Available >= 1);
        ...
        public short ReadInt16(ByteOrder mode = ByteOrder.Undefined)
        {
            Contract.Requires(this.Available >= 2);

            if (mode == ByteOrder.Undefined)
                mode = this.Mode;
        ...
        public int ReadInt32(ByteOrder mode = ByteOrder.Undefined)
        {
        ...
        public long ReadInt64(ByteOrder mode = ByteOrder.Undefined)
        {
            Contract.Requires(this.Available >= 8);
        ...
        public ushort ReadUInt16(ByteOrder mode = ByteOrder.Undefined)
        {
            Contract.Requires(this.Available >= 2);
            ...
            if (mode == ByteOrder.BigEndian)
                result = (int)this.data[this.Position++] << 8
                       | (int)this.data[this.Position++];
            else
                result = (int)this.data[this.Position++]
                       | (int)this.data[this.Position++] << 8;
        ...
        public uint ReadUInt32(ByteOrder mode = ByteOrder.Undefined)
        {
            Contract.Requires(this.Available >= 4);
            ...
            if (mode == ByteOrder.BigEndian)
                return (uint)this.data[this.Position++] << 24
                     | (uint)this.data[this.Position++] << 16
                     | (uint)this.data[this.Position++] << 8
                     | (uint)this.data[this.Position++];

            else
                return (uint)this.data[this.Position++]
                     | (uint)this.data[this.Position++] << 8
                     | (uint)this.data[this.Position++] << 16
                     | (uint)this.data[this.Position++] << 24;
        }
        ...
        /// </summary>
        /// <returns>The decoded 64-bit signed integer value.</returns>
        public ulong ReadUInt64(ByteOrder mode = ByteOrder.Undefined)
        {
            Contract.Requires(this.Available >= 8);
        ...
        public Guid ReadGuid(ByteOrder mode = ByteOrder.Undefined)
        {
            if (mode == ByteOrder.Undefined)
                mode = this.Mode;
        ...
        public Version ReadVersion(ByteOrder mode = ByteOrder.Undefined)
        {
            if (mode == ByteOrder.Undefined)
                mode = this.Mode;

            return new Version(this.ReadInt32(mode), this.ReadInt32(mode), this.ReadInt32(mode), this.ReadInt32(mode));
        }
        ...
        public void WriteInt16(short value, ByteOrder mode = ByteOrder.Undefined)
        {
        ...
        public void WriteInt32(int value, ByteOrder mode = ByteOrder.Undefined)
        {
            Contract.Requires(this.Available >= 4);
        ...
        public void WriteInt64(long value, ByteOrder mode = ByteOrder.Undefined)
        {
        ...
        public void WriteUInt16(ushort value, ByteOrder mode = ByteOrder.Undefined)
        {
            Contract.Requires(this.Capacity - this.Position >= 2);
            Contract.Ensures(this.Position == Contract.OldValue<int>(this.Position) + 2);
        ...
        public void WriteUInt32(uint value, ByteOrder mode = ByteOrder.Undefined)
        {
        ...
        public void WriteUInt64(ulong value, ByteOrder mode = ByteOrder.Undefined)
        {
            Contract.Requires(this.Capacity - this.Position >= 8);
            Contract.Ensures(this.Position == Contract.OldValue<int>(this.Position) + 8);
        ...
        public int WriteGuid(Guid id, ByteOrder mode = ByteOrder.Undefined)
        {
        ...
        /// <returns>The number of bytes written, which is always 16 for this operation.</returns>
        public int WriteVersion(Version version, ByteOrder mode = ByteOrder.Undefined)
        {
            ...
            this.WriteInt32(version.Major, mode);
            this.WriteInt32(version.Minor, mode);
            this.WriteInt32(version.Build, mode);
            this.WriteInt32(version.Revision, mode);
